    ...
    <form method="POST" action="{{ route('items.store') }}">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <div id="perishable-fields" style="display: none;">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="manufacture_date" class="form-control" max="{{ date('Y-m-d') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="shelf_life_days" class="form-control" min="1" placeholder="e.g., 7">
